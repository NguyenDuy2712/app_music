...
//            }
    ...
    fun addFavorite(){
        PlayerManager.music?.value?.let { music ->
            ...
            val music = Music("id",
                music[AppPreference.indexPlaying].nameSong,
                music[AppPreference.indexPlaying].artist,
                music[AppPreference.indexPlaying].url,
                music[AppPreference.indexPlaying].image,
                thumb,
                path
            )
    ...
    fun addDataToFirebase(music : Music) {
        val refer =  PlayerManager.database.getReference("favorite")
